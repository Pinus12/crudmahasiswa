...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>Mahasiswa</a>
                        </li>
                        <li>
                            <a href="chart.html">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                    <img src="<?= base_url('assets/')?>images/icon/logo-mini.png" alt="Cool Admin" />
                    <h2 style="margin-left:10px;">BPF TI <sup>2023</sup></h2>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="<?= site_url('Mahasiswa/')?>">
                                <i class="fas fa-tachometer-alt"></i>Mahasiswa</a>

                        </li>
                        <li>
                            <a href="<?= site_url('Prodi/')?>">
                                <i class="fas fa-chart-bar"></i>Prodi</a>
                        </li>
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>Tables</a>
